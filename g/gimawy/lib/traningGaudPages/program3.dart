                ...
                Center(
                  ...
                  Column(children: [
                    ...
                    Container(
                      child: Column(
                        children: [
                          Container(margin: EdgeInsets.only(left: 85),
                            child: Text("%نسبه تمارين كمال الجسام ستكون 100*",softWrap: true,textAlign: TextAlign.start,style: TextStyle(fontSize: 19,color: Colors.white,fontWeight: FontWeight.bold))),

                           
                             Container(margin: EdgeInsets.only(left: 192),
                              child: Text("اربع حصص في الاسبوع*",textAlign: TextAlign.start,style: TextStyle(fontSize: 19,color: Colors.white,fontWeight: FontWeight.bold))),

                            Container(margin: EdgeInsets.only(left: 155),
                              child: Text("مده التمارين لا تتعدي الساعه *",textAlign: TextAlign.start,style: TextStyle(fontSize: 19,color: Colors.white,fontWeight: FontWeight.bold))),

                             Container(margin: EdgeInsets.only(left: 30),
                              child: Text("هدف البرنامج هو التضخيم اكتساب كتله عضليه*",textAlign: TextAlign.start,style: TextStyle(fontSize: 19,color: Colors.white,fontWeight: FontWeight.bold))),
                              ...
                              P11(txt:  " اليوم1 صدر و بايسيبس "),
                               ...
                               P1(txt1:  "تمرين الصدر بالبار المستوي 4جولات تكرار 15-12-10-8", imgpath: "assets/imgs/all/t8.jpg"),
                                 ...
                                 P1(txt1:  "تمرين الرفره بالدامبل علوي 4 تكرار 12-10-8", imgpath: "assets/imgs/all/t26.jpg"),
                                      P1(txt1:  "تمرين الرفره بالدامبل مستوي 3 تكرار 12-10-8", imgpath: "assets/imgs/all/t26.jpg"),
                                ...
                                P11(txt:  " اليوم2 ارجل ,سمانه ,معده"),
                              ...
                              P1(txt1:  "تمرين احماء عضله الرجل 4جولات تكرار 12-8-8", imgpath: "assets/imgs/all/t37.jpg"),
                                ...
                                P11(txt:  " اليوم 3 راحه"),

                                 
                                


                                 P11(txt:  " اليوم 4 ظهر وترابيز وترايسبيس"),
                                ...
                                P1(txt1:  "تمرين سحب امامي ضيق 4جولات تكرار 15-12-8-8", imgpath: "assets/imgs/all/bb3.jpg"),
                                  ...
                                  P1(txt1:  "تمرين سحب امامي ضيق 4جولات تكرار 15-12-8-8", imgpath: "assets/imgs/all/t23.jpg"),
                                    ...
                                    P1(txt1:  "تمرين الحصان 4جولات تكرار 12-8-8", imgpath: "assets/imgs/all/t10.jpg"),
                                       ...
                                       P1(txt1: "تمرين سحب بالدامبل فردي 3جولات تكرار12-10-8", imgpath: "assets/imgs/all/t6.jpg"),
